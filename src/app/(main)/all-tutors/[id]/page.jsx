...
const TutorDetailsPage = async ({ params }) => {
    ...
    console.log(tutor);
    return (
        <div className="md:w-4/5 mx-auto my-20 rounded-lg p-4 space-y-2 bg-base-100 shadow-sm border-2 border-red-50 flex gap-4 items-center">
            <Image src={tutor.imageUrl} alt={tutor.name} width={100} height={100} className='w-100 h-70 rounded-lg border'></Image>
