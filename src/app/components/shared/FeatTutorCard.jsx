...
const FeatTutorCard = async ({ tutor }) => {
    ...
    return (
        <div className="rounded-lg p-4 space-y-1  bg-base-100 shadow-sm border-2 border-base-300 transition-all duration-300 hover:shadow-[8px_8px_0px_0px_#555] hover:-translate-y-1 hover:-translate-x-1">
            ...
            <p className='text-md'>Season Start Date: {formattedDate} </p>
